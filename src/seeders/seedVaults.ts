...
export const seedVaults = async () => {
  try {
    ...
    if (count > 0) {
      logger.info(`[SEED] ${count} vaults already exist, skipping seed`);
      return;
    }
    ...
    const vaults = [
      {
        ...
        earlyExitFeeBps: 500,
        tiers: [
          { minAmount: 50, maxAmount: 5000, apyPercent: 1.2 },
      ...
      },
      {
        ...
        earlyExitFeeBps: 750,
        tiers: [
          { minAmount: 100, maxAmount: 10000, apyPercent: 1.0 },
